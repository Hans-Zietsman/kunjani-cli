...
func NewRootCmd(version string) *cobra.Command {
	...
	root.AddCommand(newGetDeckCmd(version))
	root.AddCommand(newUpdateDeckCmd(version))
	root.AddCommand(newDeleteDeckCmd(version))
	...
	root.AddCommand(newDeleteQuestionCmd(version))
